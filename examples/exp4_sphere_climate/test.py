...
def main():
    ...
    parser.add_argument('--ckpt', type=str, default="checkpoint_2/checkpoint_latest.pth.tar_UNet_best.pth.tar")
    parser.add_argument('--data_folder', type=str, default="data_5",
    ...
    parser.add_argument('--fdim', type=int, default=8, help='filter dimensions')
    ...
    print("=> loaded checkpoint '{}' (epoch {} loss {:.03f}) "
          .format(args.ckpt, checkpoint['epoch'], best_loss))
