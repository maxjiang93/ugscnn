...
class LeNet(nn.Module):
    def __init__(self, device, mesh_folder):
        ...
        self.b = 32
        self.conv1 = MeshConv(1, self.b, mesh_file=os.path.join(mesh_folder, "icosphere_3.pkl"), device=device)
        self.conv2 = MeshConv(self.b, 2*self.b, mesh_file=os.path.join(mesh_folder, "icosphere_2.pkl"), device=device)
